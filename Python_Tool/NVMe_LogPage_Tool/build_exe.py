...
def build():
    ...
    cmd = [
        ...
        "--windowed",
        "--uac-admin",           # 請求管理員權限
        "--name", "NVMe_LogPage_Tool_v20",  # 版本 v20 (Windows 11 Underrun 校正、CQE 解析與多通道備援)
    ...
    exe_name = "NVMe_LogPage_Tool_v20.exe"
    exe_path = os.path.join(script_dir, "dist", exe_name)
    zip_path = os.path.join(script_dir, "dist", "NVMe_LogPage_Tool_v20.zip")
