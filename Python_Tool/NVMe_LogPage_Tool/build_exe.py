...
def build():
    ...
    cmd = [
        ...
        "--windowed",
        "--uac-admin",           # 請求管理員權限
        "--name", "NVMe_LogPage_Tool_v19",  # 版本 v19 (支援精確 Protocol-Query 4B/0x00、MMIO PCI掃描、雙重驅動引擎)
    ...
    exe_name = "NVMe_LogPage_Tool_v19.exe"
    exe_path = os.path.join(script_dir, "dist", exe_name)
    zip_path = os.path.join(script_dir, "dist", "NVMe_LogPage_Tool_v19.zip")
